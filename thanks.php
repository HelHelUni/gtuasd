  ...
  <div class="content">
    <div class="row">
      ...
      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
        <h2 class="success_page_main_title">Děkujeme za Vaši objednávku!</h2>
        <div class="success_page_top_message">Náš operátor Vás bude kontaktovat do jednoho pracovního dne.</div>
        <h3 class="success_page_bottom_message">Prosím zapněte si telefon.</h3>
        <div class="order_info_wrap">
          <ul class="order_info_item_wrap">
            <li class="order_info_item">
              <span class="order_info_item_value">Jméno: </span>
              <span id="name"></span>
            </li>
            <li class="order_info_item">
              <span class="order_info_item_value">Telefon: </span>
              <span id="phone"></span>
            </li>
          </ul>
        </div>
